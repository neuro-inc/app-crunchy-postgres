...
async def test_values_postgresql_generation_source_data_bucket_credentials(
        ...
        input_=PostgresInputs(
            ...
            source=PGDataSourceConfig(
                source_bucket=Bucket(
                    ...
                    credentials=[
                        GCPBucketCredentials(
                            bucket_name="super-bucket-name",
                            key_data=ApoloSecret(key="somekey"),
                        ),
                    ],
                ),
                repo1_path="/pgbackrest/default/pg-123/repo1",
